...
class OrderSectionLarge extends StatefulWidget {
  OrderSectionLarge({Key key}) : super(key: key);

  @override
  _OrderSectionLargeState createState() => _OrderSectionLargeState();
}

class _OrderSectionLargeState extends State<OrderSectionLarge> {
            ...
            child: Container(
              ...
              child: _chartData.isEmpty
                  ...
                  : SfCircularChart(
                      title: ChartTitle(
                          text:
                              'Number of orders over the months of the $year!'),
                      legend: Legend(
                          isVisible: true,
